...
function Floor2({ isVisible = true }) {
  const group = useRef();
  ...
  return (
    <group ref={group} scale={[1, 1, 1]} dispose={null}>
      ...
      <mesh
        ...
        material={materials.Wall}
        position={[-10.75, -0.03, 0.02]}
        rotation={[0, -Math.PI / 2, 0]}
      />
      <mesh
        geometry={nodes.Wall002.geometry}
        material={materials.Wall}
        position={[-10.16, -0.02, -1.03]}
        rotation={[0, Math.PI / 2, 0]}
      />
      <mesh
